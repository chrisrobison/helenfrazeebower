  ...
  */  
   ...
   foreach ($tmpout as $title=>$poem) {
      ...
      if ($title!="") {
         ...
         $item["stats"] = array();
         $item["stats"]["lines"] = count($lines);
         $item["stats"]["words"] = $wcount;
         $item["stats"]["characters"] = $lcount;
...
//      $insert .= implode($fields, ",") . ") VALUES (" . implode($vals,",") . ")";
//      print $insert."\n";
//      mysql_query($insert);
